...
import { LayoutDashboard, Users, UserCheck, Calendar, MessageSquare, Settings, LogOut, Menu, X } from "lucide-react"

const navigation = [
  { name: "Dashboard", href: "/dashboard/admin", icon: LayoutDashboard },
  { name: "Patients", href: "/dashboard/admin/patients", icon: Users },
  { name: "Doctors", href: "/dashboard/admin/doctors", icon: UserCheck },
